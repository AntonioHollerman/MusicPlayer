...
public abstract class DbManager {
     ...
     */
    public abstract List<Folder> getFolders(int folderId);
     ...
     */
    public abstract List<Playlist> getPlaylists(int folderId);
     ...
     */
    public abstract List<Song> getSongs(int playlistId);
     ...
     */
    public abstract void insertNewSong(Song newSong);
     ...
     */
    public abstract void insertNewPlaylist(Playlist newPlaylist);
     ...
     */
    public abstract void insertNewFolder(Folder newFolder);
